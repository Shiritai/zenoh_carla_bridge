...
fn build_topic_map() -> HashMap<&'static str, TopicInfo> {
    ...
    m.insert("initialpose", TopicInfo { entity_kind: "MS", type_name: "geometry_msgs::msg::dds_::PoseWithCovarianceStamped_", type_hash: "RIHS01_26432f9803e43727d3c8f668d1fdb3c630f548af631e2f4e31382371bfea3b6e", qos: ":1:,1:,:,:,," });
